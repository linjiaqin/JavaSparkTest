...
public class RddPipe {
    public static void main(String[] args) {
        ...
        String cPath = "file:/home/linjiaqin/sh/sparktest/hello";
        ...
        a.collect().forEach(x-> System.out.println(SparkFiles.get("hello")));
        //a.foreach(x-> System.out.println(SparkFiles.get("hello")));
        JavaRDD<String> rdd = a.pipe("./hello");     //SparkFiles.get("hello")local模式的时候用这个就行
